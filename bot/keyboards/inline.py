...
def get_profile_management_keyboard(profile_id: int):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton(text="📤 Экспортировать", callback_data=f"export_profile:{profile_id}")],
        [InlineKeyboardButton(text="« Назад к списку", callback_data="back_to_profiles")]
    ]
    return InlineKeyboardMarkup(inline_keyboard=keyboard)
